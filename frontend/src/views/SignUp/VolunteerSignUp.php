    ...
    <div>
        ...
        <table id="availabilities">
            ...
            <tr>
                ...
                <td><input type="time" name="availabilities[0][start_time]" value="09:00" ></td>
                <td><input type="time" name="availabilities[0][end_time]" value="12:00" ></td>
            </tr>
            <tr>
                <td><input type="text" name="availabilities[1][day_of_week]" value="Tuesday" readonly></td>
                <td><input type="time" name="availabilities[1][start_time]" ></td>
                <td><input type="time" name="availabilities[1][end_time]" ></td>
            </tr>
            <tr>
                <td><input type="text" name="availabilities[2][day_of_week]" value="Wednesday" readonly></td>
                <td><input type="time" name="availabilities[2][start_time]" value="14:00" ></td>
            ...
            <tr>
                ...
                <td><input type="time" name="availabilities[3][start_time]" ></td>
                <td><input type="time" name="availabilities[3][end_time]" ></td>
            </tr>
            <tr>
                <td><input type="text" name="availabilities[4][day_of_week]" value="Friday" readonly></td>
                <td><input type="time" name="availabilities[4][start_time]" ></td>
                <td><input type="time" name="availabilities[4][end_time]" ></td>
            </tr>
            <tr>
                <td><input type="text" name="availabilities[5][day_of_week]" value="Saturday" readonly></td>
                <td><input type="time" name="availabilities[5][start_time]" ></td>
                <td><input type="time" name="availabilities[5][end_time]" ></td>
            </tr>
            <tr>
                <td><input type="text" name="availabilities[6][day_of_week]" value="Sunday" readonly></td>
                <td><input type="time" name="availabilities[6][start_time]" ></td>
                <td><input type="time" name="availabilities[6][end_time]" ></td>
            </tr>
        </table>
    </div>
    <div>
